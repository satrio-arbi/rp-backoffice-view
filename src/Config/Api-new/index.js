...
export const getKaryawanSearchStore = async (search, id) => {
  const res = await NET(
    "GET",
    `karyawan/searchForStore?keyword=${search}&id_store=${id}`,
    {}
  );
...
export const getStockPerStoreStockAkhir = async (id) => {
  const res = await NET(
    "GET",
    `stockPerStore/allStockPerStore?id_store=${id}`,
    {}
  );
...
export const getStockPerStoreKeluar = async (id, str, end) => {
  const res = await NET(
    "GET",
    `stockPerStore/storeKeluar?id_store=${id}&date_from=${str}&date_to=${end}`,
    {}
  );
...
export const getStockPerStoreMasuk = async (id, str, end) => {
  const res = await NET(
    "GET",
    `stockPerStore/storeMasuk?id_store=${id}&date_from=${str}&date_to=${end}`,
    {}
  );
...
export const jurnalBukuBesar = async (data) => {
  const res = await NET(
    "GET",
    `akutansi/journal/bukuBesar?tanggal_akhir=${data?.tanggal_akhir}&tanggal_awal=${data?.tanggal_awal}&project=${data?.project}`,
    {}
  );
...
export const jurnalUmum = async (data) => {
  const res = await NET(
    "GET",
    `akutansi/journal/journalUmum?tanggal_akhir=${data?.tanggal_akhir}&tanggal_awal=${data?.tanggal_awal}`,
    {}
  );
...
export const neracaKeuangan = async (data) => {
  const res = await NET(
    "GET",
    `akutansi/neracaKeuangan?year=${data?.year}`,
    {}
  );
...
export const getDownloadPelanggan = async () => {
  const res = await NET("GET", `pelanggan/download`, {}, "", "", "", "blob");
  let a = res?.data;
...
export const getDownloadPemasok = async () => {
  const res = await NET("GET", `pemasok/download`, {}, "", "", "", "blob");
  let a = res?.data;
...
export const getDownloadInvoicePEnjualanOffice = async (data) => {
  const res = await NET(
    "GET",
    `report/invoice?id_office=${data?.office}&id_transaksi=${data?.trx}`,
    {},
    "",
    "",
    "",
...
export const getDownloadTransferRequest = async (data) => {
  const res = await NET(
    "GET",
    `pengirimanOffice/transferRequest?pengiriman_code=${data?.pengiriman_code}`,
    {},
    "",
    "",
    "",
...
export const getDownloadTransferRequestStore = async (data) => {
  const res = await NET(
    "GET",
    `pengirimanStore/transferRequest?pengiriman_code=${data?.pengiriman_code}`,
    {},
    "",
    "",
    "",
...
export const getDownloadDeliveryReceipt = async (data) => {
  const res = await NET(
    "GET",
    `returGudang/deliveryReceipt?pengiriman_code=${data?.pengiriman_code}`,
    {},
    "",
    "",
    "",
...
export const getProdukBySKU = async (id) => {
  ...
  const res = await NET(
    "GET",
    `master/product/getBySkuCode?sku_code=${id}`,
    {}
  );
...
export const getPengirimanOfficekeStoreTransferRequest = async (search) => {
  const res = await NET(
    "GET",
    `pengirimanOffice/transferRequest?pengiriman_code=${search}`,
    {}
  );
...
export const getPenenrimaanOfficeSearch = async (search) => {
  const res = await NET(
    "GET",
    `penerimaanFromOffice/search?keyword=${search}`,
    {}
  );
...
export const getPenenrimaanStoreSearch = async (search) => {
  const res = await NET(
    "GET",
    `penerimaanStoreFromStore/search?keyword=${search}`,
    {}
  );
...
export const uploadPenenrimaanStore = async (file) => {
  ...
  const res = await NET(
    "POST",
    `penerimaanStoreFromStore/import`,
    formData,
    "",
    "",
    true
...
export const getPenenrimaanSuplierSearch = async (search) => {
  const res = await NET(
    "GET",
    `penerimaanSupplier/search?keyword=${search}`,
    {}
  );
...
export const getPenyimpananKeluarSearch = async (search) => {
  const res = await NET(
    "GET",
    `penyimpananKeluar/search?keyword=${search}`,
    {}
  );
...
export const getPembelian = async (search) => {
  const res = await NET(
    "GET",
    `pembelian/getPembelian?pembelian_code=${search}`,
    {}
  );
...
export const geReportBestArticleByOffice = async (start, end, id) => {
  const res = await NET(
    "GET",
    `report/bestArticleByOffice?date_from=${start}&date_to=${end}&id_office=${id}`,
    {},
    "",
    "",
    "",
...
export const geReportBestArticleByStore = async (start, end, id) => {
  const res = await NET(
    "GET",
    `report/bestArticleByStore?date_from=${start}&date_to=${end}&id_store=${id}`,
    {},
    "",
    "",
    "",
...
export const geReportLaporanPembelian = async (start, end) => {
  const res = await NET(
    "GET",
    `report/laporanPembelian?date_from=${start}&date_to=${end}`,
    {},
    "",
    "",
    "",
...
export const geReportBarangMasuk = async (start, end) => {
  const res = await NET(
    "GET",
    `report/penyimpananMasuk?date_from=${start}&date_to=${end}`,
    {},
    "",
    "",
    "",
...
export const geReportBarangKeluar = async (start, end) => {
  const res = await NET(
    "GET",
    `report/penyimpananKeluar?date_from=${start}&date_to=${end}`,
    {},
    "",
    "",
    "",
...
export const geReportPengirimanStoretoStore = async (start, end) => {
  const res = await NET(
    "GET",
    `report/pengirimanStoreToStore?date_from=${start}&date_to=${end}`,
    {},
    "",
    "",
    "",
  ...
  link.setAttribute(
    "download",
    `pengiriman_store_to_store_${start}_${end}.pdf`
...
export const geReportPengirimanOfficetoStore = async (start, end) => {
  const res = await NET(
    "GET",
    `report/pengirimanGudangToStore?date_from=${start}&date_to=${end}`,
    {},
    "",
    "",
    "",
  ...
  link.setAttribute(
    "download",
    `pengiriman_office_to_store_${start}_${end}.pdf`
  ); //or any other extension
  document.body.appendChild(link);
  link.click();
  console.log({ link });
...
export const geReportPenerimaanFromStore = async (start, end) => {
  const res = await NET(
    "GET",
    `report/penerimaanByStore?date_from=${start}&date_to=${end}`,
    {},
    "",
    "",
    "",
...
export const geReportPenerimaanFromSupplier = async (start, end) => {
  const res = await NET(
    "GET",
    `report/penerimaanBySupplier?date_from=${start}&date_to=${end}`,
    {},
    "",
    "",
    "",
...
export const geReportPengirimanGudangToStore = async (start, end) => {
  ...
  link.setAttribute(
    "download",
    `pengiriman_gudang_to_store_${start}_${end}.pdf`
  ); //or any other extension
  document.body.appendChild(link);
  link.click();
  console.log({ link });
...
export const geReportPurchaseStoreByArticle = async (start, end, artikel) => {
  const res = await NET(
    "GET",
    `report/purchaseStoreByArticle?date_from=${start}&date_to=${end}&artikel=${artikel}`,
    {},
    "",
    "",
    "",
  ...
  link.setAttribute(
    "download",
    `purchase_store_by_artikel_${start}_${end}.pdf`
  ); //or any other extension
  document.body.appendChild(link);
  link.click();
  console.log({ link });
...
export const geReportPurchaseStoreBySummary = async (start, end, hp) => {
  const res = await NET(
    "GET",
    `report/purchaseStoreBySummary?date_from=${start}&date_to=${end}&no_hp_pelanggan=${hp}`,
    {},
    "",
    "",
    "",
  ...
  link.setAttribute(
    "download",
    `purchase_store_by_summary_${start}_${end}.pdf`
  ); //or any other extension
  document.body.appendChild(link);
  link.click();
  console.log({ link });
...
export const geReportSalesByOffice = async (start, end, id) => {
  const res = await NET(
    "GET",
    `report/salesByOffice?date_from=${start}&date_to=${end}&id_office=${id}`,
    {},
    "",
    "",
    "",
...
export const geReportStockOpname = async (start, end) => {
  const res = await NET(
    "GET",
    `report/stockOpname?date_from=${start}&date_to=${end}`,
    {},
    "",
    "",
    "",
