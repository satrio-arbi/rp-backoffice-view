...
import StockOffice from "../../Page/StockOffice";
...
import PenyimpananBarangOpnameStore from "../../Page/penyimpanan/StockOpnameStore";
...
function Routes() {
  return (
    ...
    <Switch>
      ...
      <PrivateRoute exact path="/stock-office" component={StockOffice} />
      ...
      <PrivateRoute
        exact
        path="/pengiriman/office-to-store"
        component={PengirimanGudang}
      />
      <PrivateRoute
        exact
        path="/pengiriman/store"
        component={PengirimanStore}
      />
      <PrivateRoute
        exact
        path="/pengiriman/retur-gudang"
        component={PengirimanReturGudang}
      />
      <PrivateRoute
        exact
        path="/penerimaan/ByStore"
        component={PenerimaanByStore}
      />
      <PrivateRoute
        exact
        path="/penerimaan/ByOffice"
        component={PenerimaanByOffice}
      />
      <PrivateRoute
        exact
        path="/penerimaan/ByStoreOffice"
        component={PenerimaanByStoreOffice}
      />
      <PrivateRoute
        exact
        path="/penerimaan/BySuplier"
        component={PenerimaanBySuplier}
      />
      <PrivateRoute
        exact
        path="/penyimpanan/barang-masuk"
        component={PenyimpananBarangMasuk}
      />
      <PrivateRoute
        exact
        path="/penyimpanan/barang-keluar"
        component={PenyimpananBarangKeluar}
      />
      <PrivateRoute
        exact
        path="/penyimpanan/stock-opname"
        component={PenyimpananBarangOpname}
      />
      <PrivateRoute
        exact
        path="/penyimpanan/stock-opname-store"
        component={PenyimpananBarangOpnameStore}
      />
    </Switch>
  );
}
