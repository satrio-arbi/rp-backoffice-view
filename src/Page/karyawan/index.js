  ...
  return (
    ...
    >
                  ...
                  .map((row, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="left">
                          {convertStore(row.id_store)}
                        </TableCell>
                        <TableCell align="left">
                          {convertOffice(row.id_office)}
                        </TableCell>
                        <TableCell align="left">
                          {row.total_transaksi}
                        </TableCell>
      ...
      <ModalPindahKaryawan
        ...
        data={toBeSelected}
        office={officeOption}
        submit={(lokasi_store, id_store, dats) =>
          submitPindahStore(lokasi_store, id_store, dats)
        }
