...
import {
  getOffice,
  getUkuran,
  addPenenrimaanStoreOffice,
  getStore,
  getPenenrimaanStoreOffice,
  getPenenrimaanStoreOfficeSearch,
  updatePenerimaanStoreOffice,
  deletePenenrimaanStoreOffice,
} from "../../Config/Api-new";
...
export default function PengirimanStoreStore() {
  ...
  const submitUpdateKategori = async (
    ...
    let res = await updatePenerimaanStoreOffice(
      detail_pengiriman,
      tanggal_pengiriman,
      id_store_asal,
      lokasi_store_asal,
