      ...
      >
        ...
        >
          ...
          <div>
            ...
            {d?.i === 0 || d?.i === 13 ? (
              <FormControl
                sx={{ width: "100%", marginRight: 10, marginTop: 2 }}
                variant="outlined"
              >
            ...
            {d?.i === 11 ? (
              ...
              >
                ...
                <Select
                  ...
                  label="Product"
                  onChange={(v) => {
                    setArticle(v?.target?.value);
                  }}
                >
                  {props?.prod?.map((d, i) => {
                    return (
                      <MenuItem value={d?.artikel_product}>
                        {d?.nama_product}-{d?.artikel_product}
                      </MenuItem>
                    );
                  })}
                </Select>
            ...
            {d?.i === 12 ? (
              ...
              >
                ...
                <Select
                  ...
                  label="Product"
                  onChange={(v) => {
                    setHp(v?.target?.value);
                  }}
                >
                  {props?.pelanggan?.map((d, i) => {
                    return (
                      <MenuItem value={d?.no_hp}>
                        {d?.nama_pelanggan}-{d?.no_hp}
                      </MenuItem>
                    );
                  })}
                </Select>
