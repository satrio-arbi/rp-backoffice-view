...
const ModalAddStorekeStore =(props)=>{
    ...
    return (
        ...
        p: 4, }}>
                 <div style={{display: 'flex', flexDirection:'row' }}>
                    <h2 style={{width: '100%'}} id="parent-modal-title">Add Pengiriman Store to Store</h2>
  ...
  id_store_tujuan,
  convertToko(id_store_tujuan))} variant="contained">Save</Button>
                    </div>
                </div>
...
export default ModalAddStorekeStore