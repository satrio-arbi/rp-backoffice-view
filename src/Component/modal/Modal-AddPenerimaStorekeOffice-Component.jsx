...
const ModalPenerimaanAddOfficeStore =(props)=>{
   ...
   return (
       ...
       p: 4, }}>
                <div style={{display: 'flex', flexDirection:'row' }}>
                    <h2 style={{width: '100%'}} id="parent-modal-title">Add Penerimaan Office from Store</h2>
...
export default ModalPenerimaanAddOfficeStore